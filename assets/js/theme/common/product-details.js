...
import CountdownSameDayTimer from '../cs-custom/cs-countdown-same-day-timer';
...
export default class ProductDetails {
    constructor($scope, context, productAttributesData = {}) {
        ...
        /*** countdown to same day timer */
        this.countdownSameDayTimer = new CountdownSameDayTimer(this.$scope,this.context);
    }
    ...
    updateCartContent(modal, cartItemId, onComplete) {
      ...
      $('.header-subtotle').html($('.previewCartCheckout-subtotal .previewCartCheckout-price').html())
